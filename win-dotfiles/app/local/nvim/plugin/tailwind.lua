...
local hl_cache = {}
function M.gen_opposite_hex(hex)
...
function M.gen_highlighter()
  -- has to have groups for start and end of highlighting region
  local pattern = '()%w+%-%d%d%d?()'


  return {
    pattern = pattern,
    group = function(_buf, hl_name, _data)
...
vim.g.tailwind_get_highlighter = function()
  return M.gen_highlighter()
end
